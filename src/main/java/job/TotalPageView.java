...
public class TotalPageView extends Configured implements Tool {

    public static void main(String[] args) throws Exception{
        int res = ToolRunner.run(new Configuration(), new TotalPageView(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("TotalPageView");

        job.setMapperClass(TotalPageViewMap.class);
