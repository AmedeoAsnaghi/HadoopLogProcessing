...
public class VideoDownloaded extends Configured implements Tool {

    public static void main(String[] args) throws Exception{
        int res = ToolRunner.run(new Configuration(), new VideoDownloaded(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("VideoDownloaded");

        job.setMapperClass(VideoDownloadedMap.class);
        job.setCombinerClass(SumPerDateReduce.class);
        job.setReducerClass(SumPerDateReduce.class);
